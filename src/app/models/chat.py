...
class ChatHistory(Base):
    ...
    farm_id = Column(Integer, ForeignKey("farms.id"), nullable=True)  # if farm-specific query
    ...
    message_type = Column(String, default="general")  # general, farm_specific, weather, sales, disease, market
    ...
    # Response Actions
    actions_triggered = Column(JSON)  # List of actions taken (create_todo, send_alert, etc.)
